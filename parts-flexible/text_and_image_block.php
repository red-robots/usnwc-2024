<?php if( get_row_layout() == 'text_and_image_block' ) { ?>
  ...
  <?php } ?>
    ...
    <?php if( have_rows('content_columns') ) { ?>
        ...
        <section id="three-columns-block_<?php echo $ctr ?>" class="three-columns-block three-columns-block-v2 section-content section-grid-images">
                  ...
                  <?php } else { ?>
                    ...
                    <div class="cta-buttons buttondiv">
                      <?php foreach ($buttons as $b) { 
                        ...
                        $btnTarget = (isset($btn['target']) && $btn['target']) ? $btn['target'] : '_self';
                        if($btnName && $btnLink) { ?>
                        <a href="<?php echo $btnLink ?>" target="<?php echo $btnTarget ?>" class="btn-sm xs"<?php echo $attribute ?>><span><?php echo $btnName ?></span></a>
                        <?php } ?>
                      <?php } ?>
                    </div>
                    <?php } ?>
