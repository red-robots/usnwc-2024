<?php 
 ...
 ?>
<div class="today-dropdown-mobile"  data-id="1">
	<div class="today-wrap">
		<div id="todayOptions-mobile">
			<ul>
				<li class="tablink-mobile active"><a href="#" data-tab="#mobilegroup1">WHITEWATER CENTER<span>Charlotte, NC</span></a></li>
				<li class="tablink-mobile "><a href="#" data-tab="#mobilegroup2">BIKE RANCH<span>Abingdon, VA</span></a></li>
			</ul>
		</div>
		<div class="todayContent">
			<div id="mobilegroup1" class="schedules-list-mobile active" >
				<ul class="items">
					<?php 
					...
					<?php if ($today_options) { ?>
						...
						<div id="businessHours" class="businessHours">
							<ul id="today-options" class="today-options">
								...
								?>
								<li class="info-mobile <?php echo ($t['icon_class']) ? 'hasIcon':'noIcon'; ?>">
			...
			<div id="mobilegroup2" class="schedules-list-mobile " >
				<ul class="items">
					Bike Ranch
				</ul>
			</div>
